...
class LaCTSWIGLUConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # === CSDM (fine-grained, keeps fast-weight params constant) ===
        num_slices: int = 0,          # E>=2 enables fine-grained CSDM by slicing dh into E blocks
        router_act: str = "silu",      # non-competitive activation: "silu"|"relu"|"softplus"|"square"|"identity"
        router_norm: str = "l1",       # slices normalization per token: "l1"|"l2"|"none"
        **kwargs,
    ):
